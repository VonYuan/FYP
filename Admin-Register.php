...
$admin_name = $admin_gender = $admin_nic = $admin_email = $admin_contact = $admin_password = $confirm_password = $send_password = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty(trim($_POST["admin_name"]))) {
        $admin_name = "Please enter a username.";
    } else {
    ...
    } elseif (!preg_match("/^[0-9]*$/", strlen($_POST["admin_contact"]))) {
        ...
        if ($stmt = $link->prepare($sql)) {
            ...
            if ($stmt->execute()) {
                ...
                try {
                    ...
                    //Recipients
                    $mail->setFrom("finalprojectb2022@gmail.com", "Test");
                        ...
                        <div class="card border shadow-lg p-4">
                            ...
                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" class="px-3 needs-validation" id="admin_add">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="admin_name" placeholder="Enter a Username" value="<?php echo $admin_name; ?>" required>
                                ...
                                <div class="row">
                                    ...
                                    <div class=" col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="admin_nic" placeholder="Enter the NIC Number" value="<?php echo $admin_nic; ?>" required>
