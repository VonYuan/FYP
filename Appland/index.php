...
<body>
  ...
  <header id="header" class="fixed-top  header-transparent ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.html">Petros</a></h1>
    ...
    <div class="container">
      <div class="row">
        <div
          ...
          data-aos="fade-up">
          <div>
            <h1>Welcome to Petros Billing Management System</h1>
            <h2>Petros Billing Management System is an online system to manage gas billing for the administrator and customer.
            </h2>
  ...
  <main id="main">
    ...
    <section id="features" class="features">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Features</h2>
          <p>We introduce an online system to manage gas billing for the administrator and customer.
          </p>
        </div>
    ...
    <section id="pricing" class="pricing">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Stats</h2>
          <p>Gas Bill management administrators can log into the systems through below links</p>
        </div>
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-6 box" data-aos="fade-right">
            ...
            <ul>
              <li><i class="bx bx-check"></i> Register user for Gas bill management system</li>
              ...
              <li><i class="bx bx-check"></i> Analyze gas usage for different categories</li>
              <li> Click below button to log in as an administrator</li>
            </ul>
            <a href="../Current-Admin-Login.php" class="get-started-btn">Login</a>
          </div>

          <div class="col-lg-6 box featured" data-aos="fade-left">
            <h3>Users</h3>
