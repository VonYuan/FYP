                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <div class="align-items-center text-center">
                                                <p style="font-size: 18px;">Welcome to Petros Billing System
                                                   </p style="font-size: 18px;">
                                            </div>
                                            <img src="../../images/petros.jpg" class="d-block w-100" alt="...">

                                        </div>
                                        <div class="carousel-item">
                                            <div class="align-items-center text-center">
                                                <h4>First Step</h4>
                                                <p>Register for Petros Billing  System by Providing Relevant
                                                    Information.</p>
                                            </div>
