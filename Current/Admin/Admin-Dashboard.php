        ...
        <div class="row gutters-sm">
            <div class=" col-md-4 mb-3">
                <div class="border card p-2">
                    <h2 class="align-items-center text-center">Customer Gas Usage for Month</h2>
                    <div class="card-body">
                        <?php
                        $domestic_units = $industrial_units = 0;
                        $avg_domestic = $avg_industrial = 0;
                        ...
                        $tot_units =  array();
                        $all = $domestic_units + $industrial_units ;
                        if ($all != 0) {
                            $avg_domestic = number_format(($domestic_units / $all) * 100, 2);
                            $avg_industrial = number_format(($industrial_units / $all) * 100, 2);
                           
                            array_push($tot_units, $avg_domestic, $avg_industrial);
                            $tot_methods =  array();
                            array_push($tot_methods, "Domestic", "industrial");
                        } else {
                        ?>
