                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form class="px-3 needs-validation" method="POST"
                                                        ...
                                                        <div class="form-group">
                                                            <label>Charge for Gas Consumed (Rs.)</label>
                ...
                <div class="card border shadow-lg mb-3">
                    ...
                    <div class="px-3 needs-validation">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-10 p-2">
                                <br>
                                <h4 style="text-align: center;">Petros Statement of Gas Account<h4>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Name</label>
                        ...
                        <form class="px-3 needs-validation" method="POST"
                            ...
                            <div class="form-group"><br>
                                ...
                                <textarea type="text" style="height: 200px;" class="form-control"
                                    name="message">You have not uploaded the image of your Gas meter to get update about your payable bill. Please update it as soon as possible. Extra charges may apply if the image is not uploaded before the deadline! Discard this message if you have already uploaded the image.</textarea>
                            </div>
