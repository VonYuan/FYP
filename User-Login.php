...
<div class="col-lg-6">
    <div class="row">
        <div class="col-lg-6 info">
            <i class="bx bx-map"></i>
            <h4>Address</h4>
            <p><b>Kuching Brunch</b><br>Icom Square, CT660, Level 6, Block C, 93450, 93450 Kuching, Sarawak</p>
            <p><b>Miri Brunch</b><br>2920-2928, 2920-2928, Lor Caltha, Faradale Commercial Centre, 98000 Miri, Sarawak</p>
        </div>
        <div class="col-lg-6 info">
            <i class="bx bx-phone"></i>
            <h4>Call Us</h4>
            <p><b>Kuching Brunch</b><br>082-552 901<br> <b>Miri Brunch</b><br>085-421423</p>
        </div>
        <div class="col-lg-6 info">
            <i class="bx bx-envelope"></i>
            <h4>Email Us</h4>
            <p>admin@petroleumsarawak.com</p>
        </div>
        <div class="col-lg-6 info">
            <i class="bx bx-time-five"></i>
            <h4>Working Hours</h4>
            <p>between 8:00am to 5:00pm, Monday to Friday</p>
        </div>
    </div>
</div>

<div class="col-lg-6">
    <form action="Appland/forms/contact.php" method="post" role="form" class="php-email-form" data-aos="fade-up">
        <div class="form-group">
    ...
    <!--<footer id="footer">
        ...
        <div class="container py-4">
            ...
            <div class="credits">
                <div class="copyright">
                    &copy; Copyright <strong><span>Petros/span></strong>. All Rights Reserved
                </div>
            </div>
        </div>
    </footer>--><!-- End Footer -->
